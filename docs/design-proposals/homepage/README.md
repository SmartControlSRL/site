...
SVG/CSS header animation treatment has been removed. Owner-supplied Veo videos
are integrated on Home and all four service pages in both languages. Each
page uses its own clip. They share playback controls and lifecycle handling, with separate
...
The [Managed Services video review](../managed-video/README.md) records the
rotating mechanism, retained ten-second sequence and complete framing.
