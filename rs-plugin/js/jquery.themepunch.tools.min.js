            ...
            var i,
                ...
                d = function (t) {
                    var e,
                        a,
                        o = S() - x;
                    o > c && (u += o - p), (x += o), (h.time = (x - u) / 1e3), (e = h.time - l), (!i || e > 0 || t === !0) && (h.frame++, (l += e + (e >= n ? 0.004 : n - e)), (a = !0)), t !== !0 && (r = s(d)), a && h.dispatchEvent("tick");
                };
            b.call(h),
                (h.time = h.frame = 0),
                (h.tick = function () {
                                ...
                                n
                                    ? "string" != typeof n
                                        ? n.length && n !== t && n[0] && (n[0] === t || (n[0].nodeType && n[0].style && !n.nodeType))
                                            ...
                                            : ((this._siblings[r] = $(n, this, !1)), 1 === l && this._siblings[r].length > 1 && H(n, this, null, 1, this._siblings[r]))
                ...
                if (t >= l)
                    (this._totalTime = this._time = l),
                        ...
                        0 === l &&
                            ...
                            (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > h || h === _) && h !== t && ((i = !0), h > _ && (r = "onReverseComplete")), (this._rawPrevTime = a = !e || t || h === t ? t : _));
                else if (1e-7 > t)
                ...
                (m.render = function (t, e, i) {
                    ...
                    if (
                        (t >= c
                            ...
                            : 1e-7 > t
                            ? ((this._totalTime = this._time = 0),
                              (0 !== p || (0 === this._duration && this._rawPrevTime !== r && (this._rawPrevTime > 0 || (0 > t && this._rawPrevTime >= 0)))) && ((o = "onReverseComplete"), (n = this._reversed)),
                              0 > t
                ...
                $ = function (t, e, i, r, s) {
                    ...
                    for (a in i)
                        "cssText" !== a &&
                            ...
                            ((l[a] = "auto" !== n || ("left" !== a && "top" !== a) ? (("" !== n && "auto" !== n && "none" !== n) || "string" != typeof e[a] || "" === e[a].replace(v, "") ? n : 0) : Q(t, a)),
            ...
            var he = function (t, e, i, r) {
                ...
                _e = (a.parseComplex = function (t, e, i, r, s, n, a, o, l, u) {
                    ...
                    var f,
                        ...
                        O = h !== !1;
                    for (
                        (-1 !== r.indexOf(",") || -1 !== i.indexOf(",")) && ((R = R.join(" ").replace(D, ", ").split(" ")), (C = C.join(" ").replace(D, ", ").split(" ")), (k = R.length)),
            ...
            var ve,
                ...
                Ae = (E.getTransform = function (t, e, i, r) {
                    ...
                    if (
                        (xe
                            ? (n = H(t, Te, e, !0))
                            : t.currentStyle && ((n = t.currentStyle.filter.match(O)), (n = n && 4 === n.length ? [n[0].substr(4), Number(n[2].substr(4)), Number(n[1].substr(4)), n[3].substr(4), y.x || 0, y.y || 0].join(",") : "")),
                        n && "none" !== n && "matrix(1, 0, 0, 1, 0, 0)" !== n)
                    ) {
                        for (o = (n || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], l = o.length; --l > -1; ) (h = Number(o[l])), (o[l] = (u = h - (h |= 0)) ? (0 | (u * w + (0 > u ? -0.5 : 0.5))) / w + h : h);
                        if (16 === o.length) {
                            var C = o[8],
                                k = o[9],
                                A = o[10],
                ...
                De = function (t) {
                    ...
                    if (p) {
                        ...
                        if (
                            ...
                            v ? ((_ = m / 2), (d = g / 2), (T += ", Dx=" + (_ - (_ * o + d * l) + w) + ", Dy=" + (d - (_ * h + d * u) + b) + ")")) : (T += ", sizingMethod='auto expand')"),
                            ...
                            (0 === t || 1 === t) &&
                                ...
                                0 === h &&
                                1 === u &&
                                ((v && -1 === T.indexOf("Dx=0, Dy=0")) || (x.test(e) && 100 !== parseFloat(RegExp.$1)) || (-1 === e.indexOf("gradient(" && e.indexOf("Alpha")) && f.removeAttribute("filter"))),
                            !v)
                        ) {
                            var P,
                                S,
                ...
                Le = (E.set2DTransformRatio = function (t) {
                    var e,
                        ...
                        d = p.x,
                        m = p.y;
                    return !(p.rotationX || p.rotationY || p.z || p.force3D === !0 || ("auto" === p.force3D && 1 !== t && 0 !== t)) || (p.svg && ve) || !be
                        ? ((s = p.scaleX),
                          (n = p.scaleY),
                          p.rotation || p.skewX || p.svg
                              ? ((e = p.rotation * M),
                                ...
                                (l = Math.sin(i) * -n),
                                (h = Math.cos(i) * n),
                                p.svg && ((d += p.xOrigin - (p.xOrigin * a + p.yOrigin * l)), (m += p.yOrigin - (p.xOrigin * o + p.yOrigin * h)), (f = 1e-6), f > d && d > -f && (d = 0), f > m && m > -f && (m = 0)),
                                (u = (0 | (a * r)) / r + "," + (0 | (o * r)) / r + "," + (0 | (l * r)) / r + "," + (0 | (h * r)) / r + "," + d + "," + m + ")"),
                                p.svg && ve ? _.setAttribute("transform", "matrix(" + u) : (c[xe] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + u))
                              : (c[xe] = (p.xPercent || p.yPercent ? "translate(" + p.xPercent + "%," + p.yPercent + "%) matrix(" : "matrix(") + s + ",0,0," + n + "," + d + "," + m + ")"),
                          void 0)
                    ...
                    parser: function (t, e, i, r, n, o, l) {
                        ...
                        if ("string" == typeof x.transform && xe) (f = X.style), (f[xe] = x.transform), (f.display = "block"), (f.position = "absolute"), z.body.appendChild(X), (h = Ae(X, null, !1)), z.body.removeChild(X);
                            ...
                            "string" == typeof x.x && -1 !== x.x.indexOf("%") && ((h.x = 0), (h.xPercent = re(x.x, m.xPercent))),
                                ...
                                be &&
                                    ((h.rotationX = se("rotationX" in x ? x.rotationX : "shortRotationX" in x ? x.shortRotationX + "_short" : m.rotationX || 0, m.rotationX, "rotationX", T)),
                        ...
                        for (d = parseFloat(t.offsetWidth), m = parseFloat(t.offsetHeight), o = e.split(" "), l = 0; b.length > l; l++)
                            this.p.indexOf("border") && (b[l] = V(b[l])),
                                ...
                                g !== v &&
                                    ...
                                    (T = G(t, "borderTop", _, v)),
                                    "%" === g ? ((f = 100 * (x / d) + "%"), (u = 100 * (T / m) + "%")) : "em" === g ? ((w = G(t, "borderLeft", 1, "em")), (f = x / w + "em"), (u = T / w + "em")) : ((f = x + "px"), (u = T + "px")),
            ...
            (l = a.prototype),
                ...
                (l._onInitTween = function (t, e, o) {
                    ...
                    if (
                        ...
                        "string" == typeof e && ((d = w.cssText), (l = Z(t, s)), (w.cssText = d + ";" + e), (l = $(t, l, Z(t)).difs), !Y && T.test(e) && (l.opacity = parseFloat(RegExp.$1)), (e = l), (w.cssText = d)),
                                ...
                                : ((p = H(t, a, s) + ""),
                                  ...
                                  "color" === a || "fill" === a || "stroke" === a || -1 !== a.indexOf("Color") || (m && b.test(_))
                                      ...
                                      ? ((u = parseFloat(p)),
                                        ...
                                        ("" === p || "auto" === p) &&
                                            ("width" === a || "height" === a ? ((u = te(t, a, s)), (c = "px")) : "left" === a || "top" === a ? ((u = Q(t, a, s)), (c = "px")) : ((u = "opacity" !== a ? 0 : 1), (c = ""))),
                                        (g = m && "=" === _.charAt(1)),
                                        ...
                                        c !== d &&
                                            ...
                                            u &&
                                            ((u = G(t, a, u, c)),
                                            "%" === d ? ((u /= G(t, a, 100, "%") / 100), e.strictUnits !== !0 && (p = u + "%")) : "em" === d ? (u /= G(t, a, 1, "em")) : "px" !== d && ((f = G(t, a, f, d)), (d = "px")),
                                            g && (f || 0 === f) && (_ = f + u + d)),
                                        g && (f += u),
                                        (!u && 0 !== u) || (!f && 0 !== f)
        ...
        y = function (t, e, i, s, o) {
                ...
                for (d = 0; l > d; d++)
                    (b = w[d]),
                        ...
                        (p || L || (M && !D)) &&
                            ...
                            O && ((D !== p && M) || (_.push(b), (b._x -= N)), p && d && (w[d - 1]._wordEnd = !0), "BR" === b.nodeName && b.nextSibling && "BR" === b.nextSibling.nodeName && O.push([])));
            for (d = 0; l > d; d++)
                (b = w[d]),
                    (p = b.parentNode === t),
                    "BR" !== b.nodeName
            ...
            if (O) {
                ...
                for (k = !L || (!D && !M), d = 0; O.length > d; d++) {
                    for (
                        _ = O[d], P = n.createElement("div"), P.style.cssText = "display:block;text-align:" + j + ";position:" + (L ? "absolute;" : "relative;"), H && (P.className = H + (W ? d + 1 : "")), te.push(P), l = _.length, y = 0;
                        l > y;
                        y++
                    )
                        "BR" !== _[y].nodeName &&
